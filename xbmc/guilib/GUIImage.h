...
protected:
  ...
  */
  ...
  static constexpr size_t MAX_FADING_TEXTURES = 2; ///< bound, so fast image changes can't pile up textures
  std::vector<std::unique_ptr<CFadingTexture>> m_fadingTextures; ///< textures fading out, oldest first
